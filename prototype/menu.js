    ...
    padel: {
      ...
      sections: [
        { n: '01', title: 'Play', links: [
          { label: 'Book a court',   desc: '20 DT a share · 80 DT the full court', href: '/padel#book' },
          { label: 'Tournaments',    desc: 'Cups, americanos & seasonal cups',      href: '/padel#tournaments' },
          { label: 'Coaching',       desc: 'Meet the full coaching team',           href: '/coaches' },
          { label: 'Coaching inquiry', desc: 'Book private or group sessions',      href: '/coaches#coaching-form' },
          { label: 'Court rental',   desc: 'Rent the full court for your event',    href: '/padel#book' },
        ]},
        { n: '02', title: 'Padel Shop', links: [
          { label: 'Rackets',          href: '/store?cat=rackets' },
          { label: 'Overgrips',        href: '/store?cat=accessories' },
          { label: 'Hand protectors',  desc: 'Our signature protège-main',          href: '/store?cat=accessories' },
          { label: 'Balls & tubes',    href: '/store?cat=accessories' },
          { label: 'Bags',             href: '/store?cat=accessories' },
          { label: 'Apparel',          href: '/store?cat=padelwear' },
        ]},
      ],
      thumbs: [
    ...
    pilates: {
      ...
      sections: [
        { n: '01', title: 'Classes', links: [
          { label: 'Reformer Flow',    desc: 'Spring-loaded, full-body strength',   href: '/pilates#classes' },
          { label: 'Mat Foundations',  desc: 'Where every body begins',             href: '/pilates#classes' },
          { label: 'Sculpt & Tone',    desc: 'Higher tempo, deeper burn',           href: '/pilates#classes' },
          { label: 'Private session',  desc: 'One-on-one with an instructor',       href: '/pilates#experts' },
          { label: 'Prenatal',         desc: 'Gentle, expert-led',                  href: '/pilates#classes' },
        ]},
        { n: '02', title: 'Studio', links: [
          { label: 'This week',         desc: 'Live schedule + spot counts',        href: '/pilates#schedule' },
          { label: 'Instructors',       desc: 'Meet the team',                      href: '/pilates#experts' },
          { label: 'Member stories',    href: '/pilates#schedule' },
        ]},
        { n: '03', title: 'Pilates Shop', links: [
          { label: 'Grip socks',        href: '/store?cat=pilates' },
          { label: 'Studio towels',     href: '/store?cat=towels' },
          { label: 'Resistance bands',  href: '/store?cat=pilates' },
          { label: 'Apparel',           href: '/store?cat=pilates' },
        ]},
      ],
      thumbs: [
    ...
    shop: {
      ...
      sections: [
        { n: '01', title: 'Padel Gear', links: [
          { label: 'Rackets',           href: '/store?cat=rackets' },
          { label: 'Grips & protectors', href: '/store?cat=accessories' },
          { label: 'Balls',             href: '/store?cat=accessories' },
          { label: 'Bags',              href: '/store?cat=accessories' },
        ]},
        ...
        { n: '03', title: 'Lifestyle', links: [
          { label: 'Apparel',           href: '/store?cat=padelwear' },
          { label: 'Caps & bottles',    href: '/store?cat=lifestyle' },
        ]},
      ],
      thumbs: [
    ...
    membership: {
      ...
      sections: [
        { n: '01', title: 'Plans', links: [
          { label: 'Padel Pass',       desc: '8 shares / month · priority booking', href: '/padel#plans' },
          { label: 'Pilates Monthly',  desc: 'Unlimited reformer + mat',            href: '/pilates#plans' },
          { label: 'All-Access',       desc: 'Both sports, no caps',                href: '/padel#plans' },
        ]},
        { n: '02', title: 'Credits & packs', links: [
          { label: '10-class pack',    desc: 'Pilates · valid 3 months',            href: '/pilates#plans' },
          { label: 'Court credits',    desc: 'Bulk shares at a discount',           href: '/padel#plans' },
        ]},
      ],
      thumbs: [
    ...
    club: {
      ...
      sections: [
        { n: '01', title: 'Discover', links: [
          { label: 'Coaches & instructors', desc: 'Meet the team behind Take Off', href: '/coaches' },
          { label: 'FAQ',                   desc: 'Answers to common questions',   href: '/pilates#faq' },
        ]},
      ],
      thumbs: [
